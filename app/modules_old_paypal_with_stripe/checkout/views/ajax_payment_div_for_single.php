...
<span><select class="form-control" id="selectedPaymentMethod" >
            ...
            <option value="stripe">Debit/Credit Cards</option>
            </select>
            </span>
            <!--<div class="row text-center" style="">
                <div class="col-md-6">
                    <span>
                    <input type="radio" checked="checked" value="paypal" name="selectedPaymentMethod"><img style="width:200px;" src="<?php echo BASE; ?>assets/images/paypal_new.png" /></span>
                </div>
                <div class="col-md-6">
            <span><input type="radio" value="freekassa" name="selectedPaymentMethod"><img style="width:200px;" src="<?php echo BASE; ?>assets/images/credit-debit-card-payment.png" /></span>
            </div>
            <span>Note:- Mastercard/Visa payment method accepts payment in RUB currency.</span>
            </div>-->
        ...
        You don't have to create a PayPal account to pay and PayPal accepts credit and debit cards.
    </p>
...
<script type="text/javascript">
    $('#pay').click(function(){
        ...
        //var paymentMethod = $('select[name=selectedPaymentMethod]:checked').val();
        //alert(paymentMethod);
