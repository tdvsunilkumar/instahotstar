                ...
                <fieldset class="form-fieldset m-t-20">
                  ...
                  <div class="form-group">
                    ...
                    <select name="payment_method" id="select-payments" class="form-control custom-select">
                      ...
                      ?>
                      <option value="<?php echo $row; ?>" data-data='{"image": "<?php echo BASE; ?>assets/images/payments/<?php echo $row; ?>.png"}'><?php echo $this->lang->line($row); ?></option>
                      <?php }}}else{ ?>
...
<!-- Modal -->
<div id="cardinity-payment-modal" class="modal fade" role="dialog">
  <div class="modal-dialog">

    <!-- Modal content-->
    <div class="modal-content">
        <div class="modal-header" style="border-bottom:0px;">
          <h4 style="color: #27d427;" class="modal-title text-center">Secure Checkout with Cardinity</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body" id="cardinity-payment-modal-content">
