...
class client extends MX_Controller {
	...
	public function faq(){
		...
		$data = array(
			"module"                 => get_class($this),
			"faqs"                   => $faqs,
			"page_meta_description"  => "Instahotstar provides real Instagram followers, likes, and views at a very low coast. Check the FAQ about Buying real followers and likes",
			"page_title"             => "FAQ about buying Instagram followers, Likes, and views"
		);
		$this->template->set_layout('user');
