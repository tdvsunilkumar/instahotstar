...
class Instagram_Checkpoint{
	...
	public $useragents = array(
		"Instagram 64.0.0.14.96 Android (23/6.0.1; 640dpi; 1440x2560; samsung; SM-G935F; hero2lte; samsungexynos8890)",
		/*"Instagram 64.0.0.14.96 Android (23/6.0.1; 640dpi; 1440x2560; samsung; SM-G930F; herolte; samsungexynos8890)",
		"Instagram 64.0.0.14.96 Android (23/6.0.1; 640dpi; 1440x2560; ZTE; ZTE A2017U; ailsa_ii; qcom)",
		"Instagram 64.0.0.14.96 Android (24/7.0; 640dpi; 1440x2560; HUAWEI; LON-L29; HWLON; hi3660)",
		"Instagram 64.0.0.14.96 Android (23/6.0.1; 640dpi; 1440x2392; LGE/lge; RS988; h1; h1)",
		"Instagram 64.0.0.14.96 Android (24/7.0; 380dpi; 1080x1920; OnePlus; ONEPLUS A3010; OnePlus3T; qcom)"*/
	);
	...
	function __construct($username, $password, $security_code, $proxy)
	{
		...
		if(session("ig_".$username."_user_agent")){
			$this->useragent = session("ig_".$username."_user_agent");
		}else{
			$key = array_rand($this->useragents);
			$useragent = $this->useragents[$key];
			set_session("ig_".$username."_user_agent", $useragent);
	...
	public function login($force = false){
		if($this->checkpoint_url == NULL || !$this->security_code){
			...
			unset_session("ig_".$this->username."_user_agent");
			...
			if( $login_response[1]["status"] == "fail" ){
				...
				throw new Exception("_ask_code_".lang("enter_the_6_digit_code_we_sent_to_the_email_address").$checkpoint_response[1]['step_data']['contact_point']);
