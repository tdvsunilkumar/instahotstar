...
class Instagram implements ExperimentsInterface
{
        ...
        $usernameHandler = null)
    {
        ...
        $tmpresponse = $this->request('accounts/two_factor_login/')
            ->setNeedsAuth(false)
            ...
            ->addPost('guid', $this->uuid);
        // echo "<pre>";
        // print_r($tmpresponse);exit;
            $response = $tmpresponse->getResponse(new Response\LoginResponse());
        ...
        $password)
    {
        ...
        //$this->settings->deleteUser('kft.sunil');
