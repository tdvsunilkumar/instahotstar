...
namespace Stack_Instagram\API\Framework;

use Curl\Curl;
use Stack_Instagram\Util\CustomJsonMapper;
use JsonMapper;
    ...
    public function execute(){
        ...
        switch($this->getMethod()){
            ...
            case self::GET: {
                ...
                if($curl->curlError){
                    throw new InstagramException(sprintf($error_format, $curl->errorMessage));
                }
            ...
            default: {
                throw new InstagramException(sprintf($error_format, "Unsupported Request Method"));
            }
