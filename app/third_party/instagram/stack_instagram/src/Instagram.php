...
namespace Stack_Instagram;

use Exception;
use Stack_Instagram\API\Constants;
use Stack_Instagram\API\Framework\InstagramException;
use Stack_Instagram\API\Request\BlockFriendshipRequest;
use Stack_Instagram\API\Request\BulkDeleteCommentsMediaRequest;
use Stack_Instagram\API\Request\ChangeProfilePictureAccountRequest;
use Stack_Instagram\API\Request\CommentMediaRequest;
use Stack_Instagram\API\Request\CommentsMediaRequest;
use Stack_Instagram\API\Request\ConfigureMediaRequest;
use Stack_Instagram\API\Request\CreateFriendshipRequest;
use Stack_Instagram\API\Request\CurrentUserAccountRequest;
use Stack_Instagram\API\Request\DeleteMediaRequest;
use Stack_Instagram\API\Request\DestroyFriendshipRequest;
use Stack_Instagram\API\Request\EditMediaRequest;
use Stack_Instagram\API\Request\EditProfileAccountRequest;
use Stack_Instagram\API\Request\FollowersFriendshipRequest;
use Stack_Instagram\API\Request\FollowingFriendshipRequest;
use Stack_Instagram\API\Request\InfoMediaRequest;
use Stack_Instagram\API\Request\InfoUserRequest;
use Stack_Instagram\API\Request\LikedFeedRequest;
use Stack_Instagram\API\Request\LikeMediaRequest;
use Stack_Instagram\API\Request\LocationFeedRequest;
use Stack_Instagram\API\Request\LoginRequest;
use Stack_Instagram\API\Request\ChallengeRequest;
use Stack_Instagram\API\Request\ChallengeMethods;
use Stack_Instagram\API\Request\Challenge_sendcode;
use Stack_Instagram\API\Request\Challenge_confirm_code;
use Stack_Instagram\API\Request\Challenge_sendcode_again;
use Stack_Instagram\API\Request\SaveSession;
use Stack_Instagram\API\Request\LogoutRequest;
use Stack_Instagram\API\Request\PhotoUploadRequest;
use Stack_Instagram\API\Request\PlacesFacebookSearchRequest;
use Stack_Instagram\API\Request\RemoveProfilePictureAccountRequest;
use Stack_Instagram\API\Request\SearchTagsRequest;
use Stack_Instagram\API\Request\SearchUsersRequest;
use Stack_Instagram\API\Request\SetPrivateAccountRequest;
use Stack_Instagram\API\Request\SetPublicAccountRequest;
use Stack_Instagram\API\Request\ShowFriendshipRequest;
use Stack_Instagram\API\Request\TagFeedRequest;
use Stack_Instagram\API\Request\TimelineFeedRequest;
use Stack_Instagram\API\Request\UnblockFriendshipRequest;
use Stack_Instagram\API\Request\UnlikeMediaRequest;
use Stack_Instagram\API\Request\UserFeedRequest;
use Stack_Instagram\API\Request\UserMapRequest;
use Stack_Instagram\API\Request\UserTagsFeedRequest;
use Stack_Instagram\API\Response\Model\FeedItem;
use Stack_Instagram\API\Response\Model\Location;
use Stack_Instagram\API\Response\Model\User;
...
class Instagram {
    ...
    public function setupAsNewDevice(){
        $this->setGuid($this->generateUUID());
        $this->setUuid($this->generateUUID());
        $this->setPhoneId($this->generateUUID());
        $this->setRankToken($this->generateUUID());
        $this->setGoogleAdId($this->generateUUID());
    ...
    public function login($username, $password){
        ...
        if(!$response->isOk()){
            ...
            throw new InstagramException(sprintf("%s", $response->getMessage()));
