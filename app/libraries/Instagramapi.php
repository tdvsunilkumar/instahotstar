...
if(!class_exists("instagramapi")){
    ...
    require APPPATH."third_party/instagram/instagram-php/autoload.php";

    if(file_exists(APPPATH."third_party/instagram/instagram_activity.php")){
    ...
    class instagramapi{
        ...
        public function publishComment($ig,$mediaId = null,$comment = null){
            if($mediaId != null && $comment != null){
            try{
              $mediaObject = new \InstagramAPI\Request\Media($ig);
              $commentDetails = $mediaObject->comment($mediaId,$comment);
