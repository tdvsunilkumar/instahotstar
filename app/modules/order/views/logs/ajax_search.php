                ...
                <div>
                  <small>
                    <ul>
                      ...
                      <?php if(!empty($row->visitor_id)): ?>
                      <li>Visitor ID: <?php echo (!empty($row->visitor_id)) ? $row->visitor_id : ""; ?></li>
                      <?php endif; ?>
                      <?php if(!empty($row->ipadress)): ?>
                      <li>IP Address: <?php echo (!empty($row->ipadress)) ? $row->ipadress : ""; ?></li>
                      <?php endif; ?>
                      <?php if(!empty($row->city)): ?>
                      <li>City: <?php echo (!empty($row->city)) ? $row->city : ""; ?></li>
                      <?php endif; ?>
                      <?php if(!empty($row->state)): ?>
                      <li>Region: <?php echo (!empty($row->state)) ? $row->state : ""; ?></li>
                      <?php endif; ?>
                      <?php if(!empty($row->country)): ?>
                      <li>Country: <?php echo (!empty($row->country)) ? $row->country : ""; ?></li>
                      <?php endif; ?>
                    </ul>
                  </small>
                </div>
