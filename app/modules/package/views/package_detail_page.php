   ...
   <div class="container">
      <div class="row">
         <div class="col-5 col-12 col-xl-6 col-lg-5 col-md-5 text-center flex-middle">
          ...
          <img width="350" height="292" src="<?php echo (isset($service->image))?$service->image:''; ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo (isset($service->quantity))?$service->quantity:''; ?> <?php echo (isset($service->name))?ucwords($service->name):''; ?>" srcset="<?php echo (isset($service->image))?$service->image:''; ?> 469w" sizes="(max-width: 469px) 100vw, 469px">
      ...
      <div class="row" style="margin-top: 45px;">
         ...
         <!--<p class="text-center" style="color:red;"><b>If you have any query regarding make a purchase please talk to us. To connect with our live agent, please click on chat icon at right bottom.</b></p>-->
          <img alt="money back gurantee" data-src="<?php echo BASE; ?>assets/images/30_days.png" src="<?php echo BASE; ?>assets/images/30_days.png"> 

          <img alt="buy <?php echo (isset($service->quantity))?$service->quantity:''; ?> <?php echo (isset($service->name))?ucwords($service->name):''; ?> by paypal" data-src="https://instahotstar.com/assets/images/paypal_new.png" style="margin: 0 35px;width:160px;height:47px" src="https://instahotstar.com/assets/images/paypal_new.png">

           <img alt="buy <?php echo (isset($service->quantity))?$service->quantity:''; ?> <?php echo (isset($service->name))?ucwords($service->name):''; ?> by credit/debit card" data-src="<?php echo BASE; ?>assets/images/credit-debit-card-payment.png" style="max-width: 150px;position: relative;" src="<?php echo BASE; ?>assets/images/credit-debit-card-payment.png">
