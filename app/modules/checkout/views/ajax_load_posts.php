...
<div class="account-change account-photo">
    ...
    <div class="row">
        ...
        <a href="javascript:void(0)" class="media-item item-id-<?php echo (isset($post['id']))?$post['id']:'' ?>" data-id="<?php echo (isset($post['id']))?$post['id']:'' ?>" data-url="<?php echo (isset($post['preview']))?$post['preview']:'' ?>">
            <img src="<?php echo base_64_image((isset($post['image']))?$post['image']:'');  ?>" alt="">
...
<?php endforeach; ?>
    ...
    <p><a href="#" class="btn-pink mt30 load-more-media">Load More</a></p>
     <?php  else: ?>
...
<div class="summary">
    ...
    <p><a href="#" class="btn-pink mt30" onclick="doneAllCart(); return false;">Done</a></p>
</div>