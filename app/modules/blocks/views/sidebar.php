<aside class="navbar navbar-side navbar-fixed js-sidebar" id="aside">
  ...
  <div class="flex-fill scroll-bar">
    <ul class="navbar-nav mb-md-4" id="menu">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if(segment(1) == 'pftlogs') echo "active"; else echo ""; ?>" href="<?php echo cn('pftlogs'); ?>" data-toggle="tooltip" data-placement="right" title="PayforTheme Logs">
          <span class="nav-icon">
            <i class="icon-fa fa fa-credit-card"></i>
          </span>
          <span class="nav-text">
