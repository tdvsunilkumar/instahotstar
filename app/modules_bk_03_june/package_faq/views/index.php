      ...
      <div>
        <div class="item-action dropdown action-options">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item ajaxActionOptions" href="<?php echo cn($module.'/ajax_actions_option'); ?>" data-type="all_deactive"><i class="fe fe-trash-2 text-danger mr-2"></i> All Deactivated FAQS</a>
