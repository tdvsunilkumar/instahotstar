   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-12 col-xl-6 col-lg-7 col-md-7 flex-middle">
            <div vocab="https://schema.org/" typeof="Product">
               <h1 class="section-title"> <span property="name"> <?php echo (isset($service->quantity))?$service->quantity:''; ?> <?php echo (isset($service->name))?ucwords($service->name):''; ?></span></h1>
               ...
               <img property="image" data-src="<?php echo (isset($service->image))?$service->image:''; ?>" style="display: none" src="<?php echo (isset($service->image))?$service->image:''; ?>">
               <p class="old-price medium" style="font-size: 24px;color: #bfc2fe;text-decoration: line-through;"></p>
               <div property="offers" typeof="Offer" class="price-product" style="font-size: 32px">
                  <span property="priceCurrency" content="USD">$</span><span property="price" > <?php echo (isset($service->price))?number_format((float)$service->price, 2, '.', ''):''; ?> </span>
      ...
      <div class="row" style="margin-top: 45px;">
         <div class="col-md-12 detail-page-card-items" style="padding: 40px 0 40px;text-align: center;"> 
          ...
          <img data-src="<?php echo BASE; ?>/assets/images/norton.png" style="margin: 0 35px;" src="<?php echo BASE; ?>/assets/images/norton.png">
