        ...
        <div class="row">
          ...
          <div class="col-lg-9 m-t-30  mt-lg-0">
              ...
              <div class="col-lg-4  mt-lg-0">
                ...
                <ul class="list-unstyled quick-link mb-0">
                  <?php 
                      ...
                      ?>
                      <li><a href="<?php echo cn($category->url_slug); ?>"><?php echo str_replace("Buy ","",strip_tags($category->name)); ?></a>
                        </li>
                      <?php } ?>
                </ul>
              </div>
            ...
            <ul class="list-unstyled">
              <!--<li>Tel: <?php echo get_option('contact_email',"do-not-reply@smartpanel.com"); ?></li>-->
